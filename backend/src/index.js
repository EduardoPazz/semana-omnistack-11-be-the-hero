...
const { errors } = require('celebrate'); /* usamos o erros aqui para o nodejs saber retornar uma mensagem de erro mais apropriada quando alguma validação não passa */
const app = express();
